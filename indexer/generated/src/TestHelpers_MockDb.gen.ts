...
export type entities = {
  readonly DailyStats: entityStoreOperations<Entities_DailyStats_t>; 
  readonly VaultDeposit: entityStoreOperations<Entities_VaultDeposit_t>; 
  readonly VaultWithdrawal: entityStoreOperations<Entities_VaultWithdrawal_t>
};
