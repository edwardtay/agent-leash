...
@genType
and entities = {
    @as("DailyStats") dailyStats: entityStoreOperations<Entities.DailyStats.t>,
    @as("VaultDeposit") vaultDeposit: entityStoreOperations<Entities.VaultDeposit.t>,
    @as("VaultWithdrawal") vaultWithdrawal: entityStoreOperations<Entities.VaultWithdrawal.t>,
  }
  ...
  let entities = {
      dailyStats: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.DailyStats)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.DailyStats.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      vaultDeposit: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.VaultDeposit)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.VaultDeposit.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      vaultWithdrawal: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.VaultWithdrawal)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.VaultWithdrawal.t,
            >
          ),
          ~getKey=({id}) => id,
        )
