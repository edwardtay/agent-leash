...
module SimpleVault = {
  module Deposit = {
    @genType
    let processEvent: EventFunctions.eventProcessor<Types.SimpleVault.Deposit.event> = EventFunctions.makeEventProcessor(
      ~register=(Types.SimpleVault.Deposit.register :> unit => Internal.eventConfig),
    )
...
->(Utils.magic: Types.SimpleVault.Deposit.eventArgs => Internal.eventParams)

      EventFunctions.makeEventMocker(
        ~params,
        ~mockEventData,
        ~register=(Types.SimpleVault.Deposit.register :> unit => Internal.eventConfig),
      )->(Utils.magic: Internal.event => Types.SimpleVault.Deposit.event)
    }
  }

  module Withdrawal = {
    @genType
    let processEvent: EventFunctions.eventProcessor<Types.SimpleVault.Withdrawal.event> = EventFunctions.makeEventProcessor(
      ~register=(Types.SimpleVault.Withdrawal.register :> unit => Internal.eventConfig),
    )
...
->(Utils.magic: Types.SimpleVault.Withdrawal.eventArgs => Internal.eventParams)

      EventFunctions.makeEventMocker(
        ~params,
        ~mockEventData,
        ~register=(Types.SimpleVault.Withdrawal.register :> unit => Internal.eventConfig),
      )->(Utils.magic: Internal.event => Types.SimpleVault.Withdrawal.event)
    }
  }
